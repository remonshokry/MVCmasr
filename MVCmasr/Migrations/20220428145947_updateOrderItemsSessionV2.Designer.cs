...
namespace MVCmasr.Migrations
{
    ...
    [Migration("20220428145947_updateOrderItemsSessionV2")]
    partial class updateOrderItemsSessionV2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MVCmasr.ViewModels.Order.OrderItemsSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("OrderItemsSessions");
                });

            modelBuilder.Entity("MVCmasr.ViewModels.RegisterUserViewModel", b =>
                {
                    b.Property<string>("Address")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MVCmasr.Models.ApplicationUser", null)
                        .WithMany()
